...
MANUTENCAO_HEADERS = ["ID da Manutenção", "Ativo", "Tipo", "Descrição", "Data de Início", "Data de Conclusão", "Status"]
...
class ManutencaoTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setColumnCount(len(MANUTENCAO_HEADERS))
            self.table.setHorizontalHeaderLabels(MANUTENCAO_HEADERS)
            return
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not headers_to_save:
                    headers_to_save = MANUTENCAO_HEADERS
            ...
            if not current_headers:
                current_headers = MANUTENCAO_HEADERS
