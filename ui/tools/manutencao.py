...
class ManutencaoTool(QWidget):
    """
    GUI para gerenciar dados de Manutenção.
    Permite visualizar, adicionar e salvar informações de manutenção.
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID da Manutenção", "Ativo", "Tipo", "Descrição", "Data de Início", "Data de Conclusão", "Status"])
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID da Manutenção", "Ativo", "Tipo", "Descrição", "Data de Início", "Data de Conclusão", "Status"]
            ...
            self.table.setRowCount(0)
            self.table.setColumnCount(0)
            self.table.setHorizontalHeaderLabels(["Erro", "Erro", "Erro", "Erro", "Erro", "Erro", "Erro"])
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID da Manutenção", "Ativo", "Tipo", "Descrição", "Data de Início", "Data de Conclusão", "Status"]
