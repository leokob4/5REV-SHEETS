...
class ManufacturingTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID da Ordem", "Produto", "Quantidade", "Status", "Data de Início", "Data de Término"])
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID da Ordem", "Produto", "Quantidade", "Status", "Data de Início", "Data de Término"]
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID da Ordem", "Produto", "Quantidade", "Status", "Data de Início", "Data de Término"]
