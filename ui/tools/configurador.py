...
CONFIGURATOR_HEADERS = ["ID da Configuração", "Nome da Configuração", "Versão", "Descrição"]
...
class ConfiguradorTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setColumnCount(len(CONFIGURATOR_HEADERS))
            self.table.setHorizontalHeaderLabels(CONFIGURATOR_HEADERS)
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                ws.append(CONFIGURATOR_HEADERS)
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not headers_to_save:
                    headers_to_save = CONFIGURATOR_HEADERS
            ...
            if not current_headers:
                current_headers = CONFIGURATOR_HEADERS
