...
DEFAULT_DATA_EXCEL_FILENAME = "configurador.xlsx" # Confirmar nome do arquivo
...
class ConfiguradorTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID da Configuração", "Nome da Configuração", "Versão", "Descrição"])
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID da Configuração", "Nome da Configuração", "Versão", "Descrição"]
            ...
            self.table.setRowCount(0)
            self.table.setColumnCount(0)
            self.table.setHorizontalHeaderLabels(["Erro", "Erro", "Erro", "Erro"])
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID da Configuração", "Nome da Configuração", "Versão", "Descrição"]
