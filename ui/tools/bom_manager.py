...
DEFAULT_SHEET_NAME = "BOM" # Nome da planilha padrão para esta ferramenta
...
class BomManagerTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID do BOM", "ID do Componente", "Nome do Componente", "Quantidade", "Unidade", "Ref Designator"]) # Cabeçalhos padrão
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                self.table.setRowCount(0)
                self.table.setColumnCount(0)
                self.table.setHorizontalHeaderLabels(["ID do BOM", "ID do Componente", "Nome do Componente", "Quantidade", "Unidade", "Ref Designator"])
                return
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID do BOM", "ID do Componente", "Nome do Componente", "Quantidade", "Unidade", "Ref Designator"]
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID do BOM", "ID do Componente", "Nome do Componente", "Quantidade", "Unidade", "Ref Designator"]
