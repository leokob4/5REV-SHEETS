...
DEFAULT_DATA_EXCEL_FILENAME = "financeiro.xlsx" # Confirmar nome do arquivo
...
class FinanceiroTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID da Transação", "Data", "Descrição", "Valor", "Tipo"])
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID da Transação", "Data", "Descrição", "Valor", "Tipo"]
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID da Transação", "Data", "Descrição", "Valor", "Tipo"]
