...
DEFAULT_DATA_EXCEL_FILENAME = "items_data.xlsx"
DEFAULT_SHEET_NAME = "Items"

class ItemsTool(QWidget):
    """
    GUI para gerenciar itens genéricos.
    Permite visualizar, adicionar e salvar informações de itens.
    """
    def __init__(self, file_path=None):
        ...
        self.setWindowTitle(f"Itens: {os.path.basename(self.file_path)}")
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setHorizontalHeaderLabels(["ID", "Nome", "Tipo", "Status", "Data de Criação"])
            return
    ...
    def _load_data_from_selected_sheet(self):
        ...
        try:
            ...
            if current_sheet_name not in wb.sheetnames:
                ...
                default_headers = ["ID", "Nome", "Tipo", "Status", "Data de Criação"]
        ...
        try:
            ...
            if not os.path.exists(self.file_path):
                ...
                if not current_headers:
                    current_headers = ["ID", "Nome", "Tipo", "Status", "Data de Criação"]
