...
DEFAULT_SHEET_NAME = "programacao"

PCP_HEADERS = ["ID da Ordem", "Produto", "Data de Início", "Data de Término", "Prioridade", "Status"]
...
class PcpTool(QWidget):
    ...
    def _populate_sheet_selector(self):
        ...
        if not os.path.exists(self.file_path):
            ...
            self.table.setColumnCount(len(PCP_HEADERS))
            self.table.setHorizontalHeaderLabels(PCP_HEADERS)
            return
